package com.example.enterprisapp.ui.dashboard;
...
public class DashboardFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        firestore.collection("enterprises").whereEqualTo("status_type",2).get().addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
            @Override
